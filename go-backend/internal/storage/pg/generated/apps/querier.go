...
type Querier interface {
	ClearAppBuildProgress(ctx context.Context, id string) error
	...
	GetAppsByRepoBranchProvider(ctx context.Context, arg GetAppsByRepoBranchProviderParams) ([]App, error)
